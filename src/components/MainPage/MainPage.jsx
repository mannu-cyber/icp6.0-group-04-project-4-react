...
class MainPage extends Component {
  ...
  handleLikeClick = (index) => {
    this.setState((prevState) => {
      ...
      if (likedCards.has(index)) {
        ...
        cardData[index - 1].likes--; // Decrement like count
      } else {
        likedCards.add(index); // Add if not liked
        cardData[index - 1].likes++; // Increment like count
      }
      return { likedCards };
    });
  };
  ...
  render() {
    ...
    return (
      <div className="h-[69vh] flex overflow-hidden -pt-9">
            ...
            return (
              <div key={item} className="   mx-auto mt-[0px] p-8 rounded-lg">
                ...
                <div className="flex justify-evenly mt-5 font-medium">
                  <div className={`flex items-center ${isLiked ? 'like-animation' : ''}`} onClick={() => this.handleLikeClick(item)} style={{ cursor: 'pointer' }}>
                    {isLiked ? (
                    ...
                    <span className="ml-1">{card.likes}</span> {/* Display like count */}
                  </div>

                  <div className="flex items-center text-justify">
                    <img
                      src="https://cdn.hugeicons.com/icons/bubble-chat-delay-stroke-rounded.svg"
                      alt="bubble-chat-delay"
                      width="24"
                      height="24"
                    />
                  ...
                  <div className="flex items-center">
                    <img
                      src="https://cdn.hugeicons.com/icons/share-01-stroke-rounded.svg"
                      alt="share-01"
                      width="24"
                      height="24"
                    />
